    ...
    <div class="containerMain">
        ...
        <div class="containerKananPP">
            <div class="containerKanan_SP">
                ...
                <div class="blok_SP1">
                    <div class="blok_SP_SM isiSurvey-buttonM <?php echo $survey_sistem_completed ? 'completed' : ''; ?>" id="surveySistemButton">
                        <div class="content_SP">
                ...
                <div class="blok_SP1">
                    <div class="blok_SP_DM isiSurvey-buttonM <?php echo $survey_dosen_completed ? 'completed' : ''; ?>" id="surveyDosenButton">
                        <div class="content_SP">
                            <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SP">
                            <div class="text_SP">
                                <h2>Survey Pengajar</h2>
                                <p>Berikan penilaian dosen pengajar di POLINEMA</p>
                            </div>
                        </div>
                        <img src="../../gambar/icon_arrow.png" alt="arrow" class="icon_arrow_SP">
                    </div>
