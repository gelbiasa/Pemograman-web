    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            ...
            <div class="blok_SS1">
                <div class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/industri.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Buat Survey Fasilitas</h2>
                            <p>Buat survey penilaian fasilitas</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSFmhs" class="btn-plus_SS">+</button>
                </div>
            ...
            <div class="blok_SS1">
                <div class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Buat Survey Sistem Informasi</h2>
                            <p>Buat survey penilaian sistem informasi</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSSImhs" class="btn-plus_SS">+</button>
                </div>
                <div class="blok-strip_SS"></div>
            </div>
            <div class="blok_SS1">
                <div class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Buat Survey Dosen</h2>
                            <p>Buat survey penilaian pengajar</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSDmhs" class="btn-plus_SS">+</button>
                </div>
                <div class="blok-strip_SS"></div>
            </div>
        </div>
