...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: addSoalSFtndk.php?survey_id=$survey_id&banyak_soal=$banyak_soal");
    exit();
}
?>
...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="backSSFtndk" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat soal survey -->
                <form action="koneksiSoalSFtndk.php" method="POST">
                    <?php
