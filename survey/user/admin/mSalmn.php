            ...
            <div class="blok_SS1">
                <div class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/icon_toga.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Buat Survey Pasca Kelulusan</h2>
                            <p>Buat survey penilaian pasca kelulusan</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSPKalmn" class="btn-plus_SS">+</button>
                </div>
