                ...
                <div class="blok_SS">
                    <div class="content_SS">
                        ...
                        <div class="text_SS">
                            ...
                            <p>Buat survey penilaian kualitas mahasiswa POLINEMA</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSSDMindustri" class="btn-plus_SS">+</button>
                </div>
                ...
                <div class="blok_SS">
                    <div class="content_SS">
                        ...
                        <div class="text_SS">
                            ...
                            <p>Buat survey penilaian kualitas dosen pembimbing POLINEMA</p>
                        </div>
                    </div>
                    <!-- Tombol Plus -->
                    <button id="addSDPindustri" class="btn-plus_SS">+</button>
                </div>
                <div class="blok-strip_SS"></div>
            </div>
        </div>
