...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: addSoalSDmhs.php?survey_id=$survey_id&banyak_soal=$banyak_soal");
    exit();
}
?>
...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="backSSD" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat soal survey -->
                <form action="koneksiSoalSDmhs.php" method="POST">
                    <?php
                    ...
                    <button id="submitSSD" type="submit">Simpan</button>
                </form>
            </div>
        </div>
    </div>
