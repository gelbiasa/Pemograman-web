        ...
        <div class="containerUser">
            <div>
                ...
                <div class="buttons">
                    ...
                    <button class="big"><img src="../gambar/surveyLogo.png" alt="Icon" class="icon"> Survey</button>
                    <button class="big"><img src="../gambar/hasilLogo.png" alt="Icon" class="icon"> Hasil</button>
