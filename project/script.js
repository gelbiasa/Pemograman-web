...
$(document).ready(function () {
    ...
    $("#mReport").click(function(){
        window.location.href = "mReport.php";
    });
    ...
    $("#SFmhs").click(function(){
        window.location.href = "SFmhs.php";
    });

    $("#SSImhs").click(function(){
        window.location.href = "SSImhs.php";
    });

    $("#SDmhs").click(function(){
        window.location.href = "SDmhs.php";
    });
    ...
    $("#SFdsn").click(function(){
        window.location.href = "SFdsn.php";
    });

    $("#SSIdsn").click(function(){
        window.location.href = "SSIdsn.php";
    });
    ...
    $("#SFtndk").click(function(){
        window.location.href = "SFtndk.php";
    });

    $("#SSItndk").click(function(){
        window.location.href = "SSItndk.php";
    });
    ...
    $("#SPKalmn").click(function(){
        window.location.href = "SPKalmn.php";
    });
    ...
    $("#SKPortu").click(function(){
        window.location.href = "SKPortu.php";
    });
    ...
    $("#SSDMindustri").click(function(){
        window.location.href = "SSDMindustri.php";
    });

    $("#SDPindustri").click(function(){
        window.location.href = "SDPindustri.php";
    });
    ...
    $(".btn-view").click(function(){
        var survey_nama = $(this).data('survey-nama');
        var user_status = $(this).data('user-status'); // Ambil user_status dari atribut data
        window.location.href = "hasilSurvey.php?survey_nama=" + encodeURIComponent(survey_nama) + "&user_status=" + encodeURIComponent(user_status); // Tambahkan user_status ke URL
    });
    
    $("#backV").click(function(){
        window.location.href = "mHasil.php";
    });
})
...
$(document).ready(function() {
    $(document).on('click', '#nextButton', function() {
        ...
        var totalJawaban = $(this).data('total-jawaban');
        var surveyNama = $(this).data('survey-nama');
        var userStatus = $(this).data('user-status');

        $.ajax({
            url: 'getNextJawaban.php',
            type: 'GET',
            data: {
                soal_id: soalId,
                index: currentIndex,
                survey_nama: surveyNama,
                user_status: userStatus
            },
            success: function(response) {
                $('#jawabanTerbaru').text('Jawaban Terbaru: ' + response);
                var nextIndex = currentIndex + 1;
                if (nextIndex >= totalJawaban) {
                    nextIndex = 0; // Reset to 0 if we've reached the last answer
                }
                $('#nextButton').data('current-index', nextIndex);
            }
        });
    });
});
