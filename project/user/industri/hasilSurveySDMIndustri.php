...
$survey_nama = 'Survey Sumber Daya Mahasiswa'; // Ubah sesuai kebutuhan
...
$query_responden_id = "SELECT responden_industri_id FROM t_responden_industri WHERE responden_nama = ? AND survey_id = ?";
            ...
            <div class="container_soal">
                <form>
                    ...
                    $query_jawaban = "SELECT ms.soal_nama, ms.soal_jenis, ms.no_urut, tj.jawaban 
                                      FROM t_jawaban_industri tj 
                                      JOIN m_survey_soal ms ON tj.soal_id = ms.soal_id 
                                      WHERE tj.responden_industri_id = ?";
