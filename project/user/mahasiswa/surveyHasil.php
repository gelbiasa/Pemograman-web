...
function isSurveyCompleted($user_id, $survey_name, $conn) {
    $query = "SELECT s.survey_id FROM m_survey s
              JOIN t_responden_mahasiswa r ON s.survey_id = r.survey_id
...
$survey_dosen_completed = isSurveyCompleted($user_id, 'Survey Dosen', $conn);
    ...
    <div class="containerMain">
        <?php include '../TemplateUser/sidebarUser.php'; ?>
            ...
            <div class="containerKanan_SP">
                    ...
                    <div class="blok_SP_HFM hasilSurvey-buttonM <?php echo $survey_fasilitas_completed ? 'completed' : ''; ?>" id="hasilSurveyFasilitasButton">
                        <div class="content_SP">
                            ...
                            <div class="text_SP">
                                ...
                                <p>Hasil penilaian fasilitas yang diberikan POLINEMA</p>
                            </div>
                        </div>
                ...
                <div class="blok_SP1">
                    <div class="blok_SP_HSM hasilSurvey-buttonM <?php echo $survey_sistem_completed ? 'completed' : ''; ?>" id="hasilSurveySistemButton">
                        <div class="content_SP">
                            <img src="../../gambar/icon_sistem.png" alt="icon_survey" class="icon_survey_SP">
                            <div class="text_SP">
                                <h2>Survey Sistem</h2>
                                <p>Hasil penilaian SIAKAD yang dimiliki POLINEMA</p>
                            </div>
                        </div>
                        <img src="../../gambar/icon_arrow.png" alt="arrow" class="icon_arrow_SP">
                    </div>
                ...
                <div class="blok_SP1">
                    <div class="blok_SP_HDM hasilSurvey-buttonM <?php echo $survey_dosen_completed ? 'completed' : ''; ?>" id="hasilSurveyDosenButton">
                        <div class="content_SP">
                            <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SP">
                            <div class="text_SP">
                                <h2>Survey Pengajar</h2>
                                <p>Hasil penilaian dosen pengajar di POLINEMA</p>
                            </div>
                        </div>
                        <img src="../../gambar/icon_arrow.png" alt="arrow" class="icon_arrow_SP">
                    </div>
