...
<body>
    ...
    <div class="containerMain">
        <?php include '../TemplateUser/sidebarUser.php'; ?>
            ...
            <div class="blok_SP1">
                <div class="blok_SP_FT isiSurvey-buttonT <?php echo $survey_fasilitas_completed ? 'completed' : ''; ?>" id="surveyFT_button">
            ...
            <div class="blok_SP1">
                <div class="blok_SP_ST isiSurvey-buttonT <?php echo $survey_sistem_completed ? 'completed' : ''; ?>" id="surveyST_button">
                    <div class="content_SP">
