...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SP">
            ...
            <div class="blok_SP1">
                <div id="mStndk" class="blok_SP">
                    <div class="content_SP">
                        <img src="../../gambar/user.png" alt="icon_survey" class="icon_survey_SP">
                        <div class="text_SP">
                            <h2>Survey Tendik</h2>
                            <p>Survey untuk Tendik</p>
                        </div>
                    </div>
                    <img src="../../gambar/iconArrow.png" alt="arrow" class="icon_arrow_SP">
                </div>
            ...
            <div class="blok_SP1">
                <div id="mSortu" class="blok_SP">
                    <div class="content_SP">
                        <img src="../../gambar/user.png" alt="icon_survey" class="icon_survey_SP">
                        <div class="text_SP">
                            <h2>Survey Ortu/Wali</h2>
                            <p>Survey untuk Ortu/Wali</p>
                        </div>
                    </div>
                    <img src="../../gambar/iconArrow.png" alt="arrow" class="icon_arrow_SP">
                </div>
