...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO t_pending_alumni (username, password, Nama, user_status, responden_nim, responden_nama, responden_prodi, responden_email, responden_hp, tahun_lulus) 
    VALUES ('$username', '$password', '$nama', '$user_status', '$responden_nim', '$responden_nama', '$responden_prodi', '$responden_email', '$responden_hp', '$tahun_lulus')";
