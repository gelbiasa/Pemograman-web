    ...
    <div class="containerMain">
        ...
        <div class="container_survey">
            ...
            <div class="container_soal">
                <form action="../../Koneksi/koneksiSubmitMahasiswa.php" method="POST">
                    ...
                    $query = "SELECT * FROM m_survey_soal ms INNER JOIN m_survey s ON ms.survey_id = s.survey_id WHERE s.survey_jenis = 'Mahasiswa' AND s.survey_nama = '$survey_nama'";
