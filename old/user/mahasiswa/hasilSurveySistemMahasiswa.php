...
$survey_nama = 'Survey Sistem Informasi'; // Ubah sesuai kebutuhan
...
// Ambil responden_mahasiswa_id berdasarkan responden_nama dan survey_id
$query_responden_id = "SELECT responden_mahasiswa_id FROM t_responden_mahasiswa WHERE responden_nama = ? AND survey_id = ?";
            ...
            <div class="container_soal">
                <form>
                    ...
                    $query_jawaban = "SELECT ms.soal_nama, ms.soal_jenis, ms.no_urut, tj.jawaban 
                                      FROM t_jawaban_mahasiswa tj 
                                      JOIN m_survey_soal ms ON tj.soal_id = ms.soal_id 
                                      WHERE tj.responden_mahasiswa_id = ?";
