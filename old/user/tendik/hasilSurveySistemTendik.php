...
$query_responden_id = "SELECT responden_tendik_id FROM t_responden_tendik WHERE responden_nama = ? AND survey_id = ?";
            ...
            <div class="container_soal">
                <form>
                    ...
                    $query_jawaban = "SELECT ms.soal_nama, ms.soal_jenis, ms.no_urut, tj.jawaban 
                                      FROM t_jawaban_tendik tj 
                                      JOIN m_survey_soal ms ON tj.soal_id = ms.soal_id 
                                      WHERE tj.responden_tendik_id = ?";
