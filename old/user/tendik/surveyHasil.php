...
function isSurveyCompleted($user_id, $survey_name, $conn) {
    $query = "SELECT s.survey_id FROM m_survey s
              JOIN t_responden_tendik r ON s.survey_id = r.survey_id
...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKananPP">
            ...
            <div class="blok_SP1">
                <div class="blok_SP_HFT hasilSurvey-buttonT <?php echo $survey_fasilitas_completed ? 'completed' : ''; ?>" id="hasilSurveyFT_button">
            ...
            <div class="blok_SP1">
                <div class="blok_SP_HST hasilSurvey-buttonT <?php echo $survey_sistem_completed ? 'completed' : ''; ?>" id="hasilSurveyST_button">
                    <div class="content_SP">
