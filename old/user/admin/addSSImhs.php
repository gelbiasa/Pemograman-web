...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SSImhs" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat survey -->
                <form action="addSoalSSImhs.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="hidden" name="survey_jenis" value="Mahasiswa">
                        ...
                        <button id="nextSSI" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
