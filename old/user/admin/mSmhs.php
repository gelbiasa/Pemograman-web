...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            ...
            <div class="blok_SS1">
                <div id="SSImhs" class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Survey Sistem Informasi</h2>
                            <p>Survey penilaian sistem informasi untuk mahasiswa</p>
                        </div>
                    </div>
                </div>
                <div class="blok-strip_SS"></div>
            ...
            <div class="blok_SS1">
                <div id="SDmhs" class="blok_SS">
                    <div class="content_SS">
                        <img src="../../gambar/dosen.png" alt="icon_survey" class="icon_survey_SS">
                        <div class="text_SS">
                            <h2>Survey Dosen</h2>
                            <p>Survey penilaian pengajar untuk mahasiswa</p>
                        </div>
                    </div>
                </div>
                <div class="blok-strip_SS"></div>
