...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SDPindustri" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat survey -->
                <form action="addSoalSDPindustri.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="text" id="survey_nama" name="survey_nama" value="Survey Dosen Pembimbing"><br>
                        ...
                        <button id="nextSDPindustri" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
