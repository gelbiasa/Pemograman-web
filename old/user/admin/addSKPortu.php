...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SKPortu" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat survey -->
                <form action="addSoalSKPortu.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="hidden" name="survey_jenis" value="Orang Tua">
                        ...
                        <input type="text" id="survey_nama" name="survey_nama" value="Survey Kepuasan Pelayanan"><br>
                        ...
                        <button id="nextSKPortu" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
