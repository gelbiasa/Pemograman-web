...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SSItndk" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <form action="addSoalSSItndk.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="hidden" name="survey_jenis" value="Tenaga Pendidik">
                        ...
                        <input type="text" id="survey_nama" name="survey_nama" value="Survey Sistem Informasi"><br>
                        ...
                        <button id="nextSSItndk" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
