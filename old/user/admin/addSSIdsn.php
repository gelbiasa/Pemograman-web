...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SSIdsn" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat survey -->
                <form action="addSoalSSIdsn.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="hidden" name="survey_jenis" value="Dosen">
                        ...
                        <button id="nextSSIdsn" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
