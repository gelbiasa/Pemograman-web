...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="SSDMindustri" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat survey -->
                <form action="addSoalSSDMindustri.php" method="POST">
                    <div class="surveyInput">
                        ...
                        <input type="hidden" name="survey_jenis" value="Industri">
                        ...
                        <input type="text" id="survey_nama" name="survey_nama" value="Survey Sumber Daya Mahasiswa"><br>
                        ...
                        <button id="nextSSDMindustri" type="submit">Next</button>
                    </div>
                </form>
            </div>
        </div>
