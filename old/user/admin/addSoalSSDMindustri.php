...
// Periksa apakah data dari form telah disubmit
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: addSoalSSDMindustri.php?survey_id=$survey_id&banyak_soal=$banyak_soal");
    exit();
}
?>
...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="containerKanan_SS">
            <button id="backSSSDMindustri" class="btn-back_SS">Back</button>
            <div class="container_form_SS">
                <!-- Form membuat soal survey -->
                <form action="koneksiSoalSSDMindustri.php" method="POST">
                    <?php
                    ...
                    <button id="submitSSSDM" type="submit">Simpan</button>
                </form>
            </div>
        </div>
    </div>
