...
function isSurveyCompleted($user_id, $survey_name, $conn) {
    $query = "SELECT s.survey_id FROM m_survey s
              JOIN t_responden_alumni r ON s.survey_id = r.survey_id
...
$survey_pascaKelulusan_completed = isSurveyCompleted($user_id, 'Survey Pasca Kelulusan', $conn);
?>
<!DOCTYPE html>
<html lang="id">
    ...
    <div class="containerMain">
        ...
        <div class="containerKananPP">
            <div class="containerKanan_SP">
                <div class="blok_SP1">
                    <div class="blok_SP_HPK hasilSurvey-buttonA <?php echo $survey_pascaKelulusan_completed ? 'completed' : ''; ?>" id="hasilSurvey_PK_AlumniButton">
                        <div class="content_SP">
                            <img src="../../gambar/icon_toga.png" alt="icon_survey" class="icon_survey_SP">
                            <div class="text_SP">
                                <h2>Survey Pasca Kelulusan</h2>
                                <p>Berikan penilaian pasca kelulusan</p>
                            </div>
                        </div>
