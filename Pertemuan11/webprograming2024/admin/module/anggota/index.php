<!-- Praktikum 5. Folder Module – Bagian Anggota Langkah 2 index.php -->
<div class="container-fluid">
    <div class="row">
        <?php
        // Memasukkan menu.php yang berisi navigasi ke halaman lain
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row">
                ...
                <?php
                // Menampilkan pesan kilat jika ada
                        ...
                        <div class="modal-content">
                            ...
                            <form action="fungsi/tambah.php?anggota=tambah" method="post">
                                <div class="modal-body">
                                    <!-- Form untuk memasukkan data anggota baru -->
                                    <!-- Field Nama -->
                                    <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <!-- Tombol untuk menyimpan data anggota baru -->
